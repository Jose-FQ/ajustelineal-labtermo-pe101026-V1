...
- Para etiquetar los ejes, puede emplear formato LaTeX. Por ejemplo: $\Delta T$ debe escribirse como `$\Delta T$`; $\ln\left(\frac{P}{P_o}\right)$, como $\ln \left( \fracc{P}{P_o} \right)$; y $c_{\text{metal}}$, como $c_{\text{metal}}$
        """
    )
